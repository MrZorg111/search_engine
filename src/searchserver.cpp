...
int SearchServer::SumCount(const std::vector<Entry>& num){
    int result = 0;
...
std::vector<std::vector<std::string>> SearchServer::PreRequest(const std::vector<std::string>& request_list){
...
std::vector<std::vector<std::pair<int, float>>> SearchServer::PreAnswer(const std::vector<std::vector<RelativeIndex>>& search_result) {
